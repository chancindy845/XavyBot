...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const time = moment.tz('America/Medellin').format('HH:mm:ss')
			const date = moment.tz('America/Medellin').format('DD/MM/YY')
...
//FIN DE REGISTRO  
		...
		if (budy.includes(`Todo bien`)) {
                ...
                if (budy.includes(`Kuakers`)) {
		  reply(`Son Legiovirgos`)
		  }
